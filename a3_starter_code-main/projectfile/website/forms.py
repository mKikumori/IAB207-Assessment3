...
class BookingForm(FlaskForm):
    ...
    card_number = StringField("Enter card number:", validators=[InputRequired(), Regexp(
        "^(?:4[0-9]{3}-[0-9]{4}-[0-9]{4}-[0-9]{4}|[25][1-7][0-9]{2}-[0-9]{4}-[0-9]{4}-[0-9]{4}|6(?:011|5[0-9][0-9])-[0-9]{4}-[0-9]{4}-[0-9]{4}|3[47][0-9]{3}-[0-9]{4}-[0-9]{4}-[0-9]{4}|3(?:0[0-5]|[68][0-9])-[0-9]{4}-[0-9]{4}-[0-9]{4}|(?:2131|1800|35\d{3})-[0-9]{4}-[0-9]{4}-[0-9]{4})$",
        message="Not valid card number")])
    CVS = IntegerField("Enter card's CCS:", validators=[InputRequired()])
    expiry_date = DateTimeField(
        "Enter card's expiry date (mm/YYYY):", validators=[InputRequired()], format="%m/%Y")
    emailid = Email("Enter your email", validators=InputRequired())
